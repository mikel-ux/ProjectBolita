...
public class Player extends Entity {
    ...
    public boolean muerte(Entity entity) {
        ...
        */
        ...
        (
            // Arriba izquierda
            (screenX <= entity.enemyX + entity.solidArea_vertical.width
            && screenX >= entity.enemyX
            && screenY <= entity.enemyY + gp.hunter.solidArea_vertical.height
            && screenY >= entity.enemyY)
                ||
            // Arriba derecha
            (screenX + gp.player.solidArea_horizontal.width <= entity.enemyX + entity.solidArea_vertical.width
            && screenX + gp.player.solidArea_horizontal.width >= entity.enemyX
            ...
            (screenX <= entity.enemyX + entity.solidArea_vertical.width
            && screenX >= entity.enemyX
            && screenY + gp.player.solidArea_vertical.height <= entity.enemyY + entity.solidArea_vertical.height
            && screenY + gp.player.solidArea_vertical.height >= entity.enemyY)
                ||
            // Abajo derecha
            (screenX + gp.player.solidArea_horizontal.width <= entity.enemyX + entity.solidArea_vertical.width
            && screenX + gp.player.solidArea_horizontal.width >= entity.enemyX

...
public class Dron extends Entity {
    ...
    public void update() {
        ...
        if (gp.player.worldX >= 1150 && gp.player.worldX <= 1600 && dronY < 150 && !subida){
            speedDron -= 5;
        }
        else if (gp.player.worldX > 1600 && dronY > -450 || (subida && (gp.player.worldX >= 1150 && gp.player.worldX <= 1600))){
            speedDron += 5;
            subida = true;
        }
        if (dronY <= -450){
    ...
    public void draw(Graphics2D g2) {
        ...
        if (!tope){
            dronY = worldY - gp.player.worldY + gp.player.screenY - speedDron;
        } else{

...
public class Dron extends Entity {
    ...
    public void update() {
        ...
        if (gp.player.worldX >= 1150 && gp.player.worldX <= 1500 && dronY < 150 && !subida){
            speedDron -= 4;
        }
        else if (gp.player.worldX > 1500 && dronY > -450 || (subida && (gp.player.worldX >= 1150 && gp.player.worldX <= 1500))){
            speedDron += 4;
            subida = true;
        }
        if (dronY <= -450){

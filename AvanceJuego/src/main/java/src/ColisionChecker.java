...
public class ColisionChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        System.out.println(tileOn1 + "|" + tileOn2);
        System.out.println(tileDown1 + "|" + tileDown2);
        System.out.println(tileLeft1 + "|" + tileLeft2);
        System.out.println(tileRight1 + "|" + tileRight2);

...
public class Hunter extends Entity {
    ...
    public void update() {
        ...
        // ------------------------------- MOVIMIENTO IZQ - DER ----------------------------------- //
        if (!gp.player.muerte(this)) {
            if (enemyX + gp.player.worldX < limiteDer && directionRight) {
                speedHunter -= 2;
            } else {
                directionRight = false;
            }

            if (!directionRight && enemyX + gp.player.worldX > limiteIzq) {
                speedHunter += 2;
            } else {
                directionRight = true;
            }
    ...
    public void draw(Graphics2D g2) {
        ...
        // Origen de Hunter
        int worldCol = 22, worldRow = 8;

        int worldX = worldCol * gp.tileSize;
        int worldY = worldRow * gp.tileSize;
        enemyX = worldX - gp.player.worldX + gp.player.screenX - speedHunter;
        enemyY = worldY - gp.player.worldY + gp.player.screenY - speedJumpHunter;

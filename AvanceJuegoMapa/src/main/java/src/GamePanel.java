...
public class GamePanel extends JPanel implements Runnable {
    ...
    //Si van a hacer un selector de nivel cuando quieran cambiar el nivel hagan que sea true esto y pongan el curlevel al nivel que quieran
    
    boolean winall=false;
    ...
    public void info(Graphics g){
     Font fuente = new Font("Arial", Font.BOLD, 20);
        g.setFont(fuente);
        g.setColor(WHITE);
        g.drawString("X: "+player.worldX+" Y: "+player.worldY, 0, 26);

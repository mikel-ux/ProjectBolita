...
public class Player extends Entity {
    ...
    public void update() {
        ...
        if (keyH.up == true && maxalt == false && finsalto == false) {
            ...
            if ("up&right".equals(direction) && !colisionLeft) {
                worldX += speed;
            }
            ...
            if ("up&left".equals(direction) && !colisionRight) {
                worldX -= speed;
            }
...
//                break;
    ...
    public void draw(Graphics2D g2) {
        ...
        g2.setFont(fuente);
        g2.setColor(WHITE);
        g2.drawString("Arriba " + colisionOn + "---Derecha " + colisionRight + "---Izquierda " + colisionLeft + "----Abajo " + colisionDown, 0, 16);
